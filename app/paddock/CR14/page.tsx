                    ...
                    >
                      ...
                      <AnimatePresence>
                        {isHovered && (
                          ...
                          >
                            <p className="text-xl md:text-3xl font-bold text-white">CR14 Prototype</p>
                          </motion.div>
                        )}
                      </AnimatePresence>
                    </div>
                ...
                <ScrollArea className="h-[400px] w-full rounded-md bg-white">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
                    {achievements.map((achievement, index) => (
                      <PinContainer key={index} title={achievement.title} icon={achievement.icon} className={achievement.position === 1 ? "border-2 border-yellow-400" : ""}>
